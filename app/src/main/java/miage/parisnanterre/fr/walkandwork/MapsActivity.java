...
//                }
                ...
                GPSLocationCallback= new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                       ...
                       /* try {
                            String response = (String) updatePosition.get();
                            Toast.makeText(MapsActivity.this, response, Toast.LENGTH_LONG).show();
                            Log.d("POSITIONUSER",response);
...
//=========================Fin de GPSUpdateLocation================================
    ...
    class UpdatePosition extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                return httpQuery.UpdatePosition(args[0],args[1],args[2],args[3]);
            } catch (IOException e) {
                e.printStackTrace();
                return null;
            }
